                                            ...
                                            <tbody>
                                                ...
                                                foreach ($AllPatients as $patient) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <a href="patient-details.php?id=<?php echo $patient['id'] ?>"> <button class="btn btn-sm btn-icon btn-pure btn-default on-editing m-r-5 button-save" data-toggle="tooltip" data-original-title="Comments"><i class="icon-drawer" aria-hidden="true"></i></button></a></td>
                                                    </tr>
                                                    <?php
                                                       }
                                                }
