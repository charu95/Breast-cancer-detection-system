                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="card member-card">
                                <div class="header l-coral">
                                    <h4 class="m-t-10 text-light"><?php echo $PATIENT->name; ?></h4>
                                </div>
                                <div class="member-img">
                                    <a href="patient-invoice.html">
                                        <img src="../upload/patient/<?php echo $PATIENT->image_name; ?>" class="rounded-circle" alt="profile-image">
                                    </a>
                                </div>
                                <div class="body">
                                    <div class="col-12">
                                        PI <?php echo $PATIENT->id; ?>                     
                                    </div>
                                    <hr>
                                ...
                                <div class="body">
                                    ...
                                    <div class="tab-content mt-3">
                                        ...
                                        <div class="tab-pane active" id="activity">
                                            <h4 class="m-b-0"><strong>Radiologist</strong> Comment</h4>
                                            <br>
                                            <?Php
                                            ...
                                            <ul class="right_chat list-unstyled">
                                                <li class="online">
                                                    <a href="javascript:void(0);">
                                                        <div class="media">
                                                            <img class="media-object " src="../assets/images/u.png" alt="">
                                                            <div class="media-body">
                                                                <span class="name">Dr. Sunil Perera</span>
                                                                <span class="message">Radiologist</span>
